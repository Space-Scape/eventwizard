...
boss_drops = {
    ...
    "Alchemical Hydra": ["Ikkle hydra", "Hydra's claw", "Jar of chemicals"],
    "Amoxliatl": ["Moxi"],
    "Araxxor": ["Araxyte fang", "Aranea boots", "Jar of venom", "Nid"],
    ...
    "Grotesque Guardians": ["Noon/midnight", "Granite ring", "Jar of stone"],
    "Hueycoatl": ["Huberte", "Tome of earth (empty)"],
    "King Black Dragon": ["Draconic visage", "Prince black dragon"],
    ...
    "Nightmare": ["Little nightmare/Parasite", "Inquisitor's great helm", "Inquisitor's hauberk", "Inquisitor's plateskirt", "Inquisitor's mace", "Eldritch orb", "Harmonised orb", "Volatile orb", "Jar of dreams"],
    ...
    "Tombs of Amascut": ["Tumeken's Guardian", "Masori mask", "Masori body", "Masori chaps", "Lightbearer", "Tumeken's shadow (uncharged)"],
    ...
    "Venenatis": ["Venenatis spiderling", "Fangs of venenatis"],
    "Vet'ion": ["Vet'ion jr.", "Skull of vet'ion"],
    "Vorkath": ["Vorki", "Draconic visage", "Skeletal visage", "Jar of decay"],
